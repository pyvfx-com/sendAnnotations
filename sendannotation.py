...
from utils.grabScreen import grab_screenshot
...
class send_screenshot(Ui_Form, QWidget):
    def __init__(self):
        ...
        self.setWindowTitle(f"Show: dev Quick annotation send v1.7.38 ({os.getlogin()})")
        self.screen_grab = os.path.join(
            os.path.expanduser("~/.cache/screenshot/"),
    ...
    def save_image(self, receiver=None, sender=None):
        ...
        seml(Annotation=self.screen_grab, Sender=send, Receiver=rece)
        self.close()
